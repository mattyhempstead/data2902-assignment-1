...
```{r}
cat("Number of samples:", dim(df)[1])
```
There are 572 people enrolled in DATA2X02, only 174 answered bc voluntary.
...
Yes i tihnk so "Recall bias"
Try to list other biases by their name
"respondents not want to answer a certain way due to stigma"


Likely that some people didn't answer / answers more than once, or did not take survey seriously. Is this a bias?

People who answer survey are potentially those who are more involved in university work, and may have higher study hours as a result.

People often will pick *nice* rounded numbers, such as for the number of hours studied. A large portion of answers ended with a $0$, when 
